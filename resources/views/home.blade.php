       ...
       <header id="header">
        <div id="myCarousel" class="carousel slide">
          ...
          <ol class="carousel-indicators">
            ...
            <li class="hidden-sm hidden-xs" data-target="#myCarousel" data-slide-to="2"></li>
          ...
          <div class="carousel-inner">
            ...
            <!-- *****  Logo ***** -->
            <div class="logo-container center-align text-center logo-home">
              <a href="#">
                ...
                <!-- =========================
                   ...
                   <div class="item active">
                    ...
                    <div class="carousel-caption">
                      <h1 class="light mab-none">Necesitas un auto?</h1><br>
                      ...
                      <div class="call-button">
                        <div class="row">
                          <div class="col-md-3 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-12">
                           ...
                           {!! link_to('alquiler','Galería',array('class'=>'button pull-left internal-link bold-text main-bg hvr-grow titulos_valores')) !!}
                         </div>
                ...
                <!-- =========================
                   ...
                   <div class="item">
                    ...
                    <div class="carousel-caption">
                      <h1 class="light mab-none">Mi carro es tu carro!</strong></h1>
                      
                      <h2 class="light titulos_banner">Lógra ingresos extras con tu carro </h2><br>
                      <div class="call-button">
                        <div class="row">
                          <div class="col-md-3 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-12">
                           {!! link_to('postular','Postular',array('class'=>'button pull-left internal-link bold-text main-bg hvr-grow titulos_valores')) !!}
                         </div>
         ...
         <!--            <div class="carousel-caption">
                      ...
                      <p class="light margin-bottom-medium">Recorre todos los caminos con ofertas grandiosas <br>o si prefieres postula tu carro para obtener dinero extra.</p>
                      <div class="call-button">
                        <div class="row">
                          <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-12">
                            <a href="servicios" class="button pull-right internal-link bold-text light hvr-grow" data-rel="#portfolio">Servicios</a>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="contacto" class="button pull-left internal-link bold-text main-bg hvr-grow" data-rel="#about-us">Contactanos</a>
                          </div>
...
<!--                       <h1 class="light mab-none">Vive Kilometros de <br><strong class="bold-text">Experiencia</strong></h1>
 -->                      
                      <h2 class="light titulos_banner">Hemos ganado dinero con <br>nuestro carro, 
                      alquilándoselo a otras<br> personas y empresas de forma segura. </h2><br>

                        <div class="call-button">
                          <div class="row">
                             <div class="col-md-3 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-12">
                           {!! link_to('contacto','Contactos',array('class'=>'button pull-left internal-link bold-text main-bg hvr-grow titulos_valores')) !!}
                            </div>
